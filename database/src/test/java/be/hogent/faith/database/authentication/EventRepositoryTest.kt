...
class EventRepositoryTest {
    ...
    private val fileStorageRepository = mockk<be.hogent.faith.storage.IFileStorageRepository>()
    private val eventDatabase = mockk<EventDatabase>()
    private val eventEncryptionService = mockk<be.hogent.faith.service.usecases.encryption.IEventEncryptionService>()
    ...
    fun `when requesting an events data and the database holds the requested event, it is returned`() {
        ...
        // Act
        eventRepository.get(event.uuid)
            .test()
