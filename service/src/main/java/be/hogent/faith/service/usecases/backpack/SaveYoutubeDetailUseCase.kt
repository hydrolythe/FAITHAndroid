...
class SaveYoutubeDetailUseCase(
    private val backpackRepository: IDetailContainerRepository<YoutubeVideoDetail>,
    ...
    private fun addDetailToBackpack(youtubeDetail: YoutubeVideoDetail): Single<Detail> =
        Single.fromCallable {
