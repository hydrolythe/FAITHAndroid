...
interface DetailFinishedListener {
    /**
     * Will be called when the user has created the file and must enter the details metadata
     */
    fun onGetDetailsMetaData(detailsMetaDataStrategy: DetailsMetaDataStrategy)
    /**
