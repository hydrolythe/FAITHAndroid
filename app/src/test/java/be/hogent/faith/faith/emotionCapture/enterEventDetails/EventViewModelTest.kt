...
class EventViewModelTest {
    ...
    private var saveEventUseCase = mockk<SaveEventUseCase>(relaxed = true)
    ...
    @Before
    fun setUp() {
        val userLiveData = mockk<LiveData<User>>(relaxed = true)
        every { userLiveData.value } returns UserFactory.makeUser()
